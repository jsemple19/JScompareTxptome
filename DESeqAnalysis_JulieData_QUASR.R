...
###############################################################
countTable<-read.table(paste0(outPath,"/../quasr-gene-WS275.tab"),
                       stringsAsFactors=F, header=T)
countTable$width<-NULL
colnames(countTable)<-sampleTable$sampleName
...
## basic sample stats
sink(file=paste0(outPath,"/txt/",fileNamePrefix,"logfile.txt"),append=FALSE, type="output")
